            ...
            <div class="col-md-12">
              ...
              <div class="box box-success">
                <div class="box-header">
                  <h3 class="box-title"><a href="index.php" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Kembali</a></h3>
                </div><!-- /.box-header -->
                  <div class="box-body">
                    <h2 align="center"><b><?php echo $data['judul']; ?></b></h2><br> 
                    <center> 
                        <img src="../admin/proses/images/<?php echo $data['foto']; ?>" style="width: 500px;">  
                    </center>
