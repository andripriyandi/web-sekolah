        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h1 class="box-title">Ubah Halaman Home</h1>
            ...
            <div class="box-body">
              ...
              ?>
              <form method="post" action="proses/pu_home.php?id=<?= $data['id']; ?>" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <div class="form-group">
                      <label>Alamat*</label>
                      <div class="input">
                      <textarea class="tinymce" rows="12" name="alamat"> <?php echo $data['alamat']; ?></textarea>
                    </div>
                    </div>
