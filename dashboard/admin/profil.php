...
<?php include "_partials/sidebar.php"; ?>
  ...
  <!-- Content Header (Page header) -->
	 <section class="content-header">
      <h1>Profil User<small>Preview</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-th"></i> Profil User</a></li>
      </ol>
    </section>
                ...
                <div class="box-body">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="box-body box-profile">
                      <img class="profile-user-img img-responsive img-circle" src="proses/images/<?= $data['foto']; ?>" alt="User profile picture">
                  ...
                  <div class="box-footer">
                    <button type="submit" name="submit" class="btn btn-info pull-right btn-block"> <i class="fa fa-save"></i> Update Profile</button>
                  </div>
